...
gulp.task('copy', function () {
    return gulp.src([
        ...
        .pipe(gulp.dest('dist/gsquared-theme'));
});
...
gulp.task('pot', function () {
    return gulp.src('**/*.php')
        .pipe(pot({
            domain: 'gsquared-theme',
            package: 'gsquared-theme'
        }))
 ...
 */
gulp.task('default', gulp.series('scssTask', 'cssConcat', 'jsConcat'));